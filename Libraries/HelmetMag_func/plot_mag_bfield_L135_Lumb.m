function [ outdum ] = plot_mag_bfield_Lumb( Mout, optimvalues, state, Bout, ROImsk_or, xx_a, yy_a, zz_a,cm_rb, figoff )
...
%     Bout = D2d * Mout;
    ...
    dispBvec_Lumb(Bout, ROImsk_or,'mag','XZ',31);
    figure(30+figoff); hold off; colormap(cm_rb); hcb = colorbar; caxis(mean(Bm(:)) + [-2e-4 2e-4]); set(hcb,'color',[1 1 1]); drawnow
    %% show magnetization
