function [ fac_blk, ver_blk, Rot_eul ] = gen_facver_plug( xyz_ctr, xyz_sz, phi_blk, tht_blk, psi_blk, facnum, hplug )
...
%%
    ...
    xsz_op = xyz_sz(1)/2 + hplug;
    ysz_op = xyz_sz(2)/2 + hplug;
    zsz_op = xyz_sz(3)/2 + hplug;
