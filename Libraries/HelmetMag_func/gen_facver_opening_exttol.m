function [ fac_blk, ver_blk ] = gen_facver_opening( xyz_ctr, xyz_sz, phi_blk, tht_blk, psi_blk, facnum, tcoffer, exttol )
...
%%
    ...
    xsz = xyz_sz(1)/2 + tcoffer + exttol;
    ysz = xyz_sz(2)/2 + tcoffer + exttol;
    zsz = xyz_sz(3)/2 + tcoffer + exttol;
    
    xsz_op = xyz_sz(1)/2 + exttol;
    ysz_op = xyz_sz(2)/2 + exttol;
    zsz_op = xyz_sz(3)/2 + exttol;
