function [ Bxyz ] = Bcomp135_xsz_numadj( D135, J3, J5, Mxyz, errcoefs )
% Compute B-field from Mxyz using numerically-derived block SH error coeffs
...
%     Br = 1.6593;
    ...
    %% manage error terms
    M1off = zeros(numel(Mxyz)/3,1);
    M3err = zeros(numel(Mxyz)*7/3,1);
    M5err = zeros(numel(Mxyz)*11/3,1);
