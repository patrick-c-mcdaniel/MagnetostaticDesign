...
% get from magnet optimization setup
...
[listNode, listTriangle, tri] = importMeshWavefront('./mesh/meshGx_Example_200626.obj');
...
ROImsk_s1 = circshift(ROImsk_or_vol,[3 0 0]);
ROImsk_s2 = circshift(ROImsk_or_vol,[6 0 0]);
...
save('./precomp/OptSetupGx_Example_200626.mat','Btarg','ROImsk_tar','x3tar','y3tar','z3tar','optimizationType','reg','calculateR','calculateL','calculateLwp','rk','targetCoil');

save('./precomp/coil_OptSetupGx_Example_200626.mat','coil');