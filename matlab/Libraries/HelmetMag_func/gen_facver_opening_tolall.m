function [ fac_blk, ver_blk ] = gen_facver_opening_tolall( xyz_ctr, xyz_sz, phi_blk, tht_blk, psi_blk, facnum, tcoffer, tolall )
...
%%
    ...
    xsz = xyz_sz(1)/2 + tcoffer + tolall;
    ysz = xyz_sz(2)/2 + tcoffer + tolall;
    zsz = xyz_sz(3)/2 + tcoffer + tolall;
    
    xsz_op = xyz_sz(1)/2 + tolall;
    ysz_op = xyz_sz(2)/2 + tolall;
    zsz_op = xyz_sz(3)/2 + tolall;
