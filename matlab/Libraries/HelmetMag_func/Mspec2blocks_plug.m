function [ ver_all, fac_all ] = Mspec2blocks_plug( MagBlkSpec, tol, hplug, facnums, fignum )    
...
if nargin<5
    ...
    %     end
        ...
        [ fac_blk ver_blk ] = gen_facver_plug([ xPos, yPos, zPos],[ xSize ySize zSize ], phi*pi/180, tht*pi/180, psi*pi/180, facnums(iblk), hplug);
