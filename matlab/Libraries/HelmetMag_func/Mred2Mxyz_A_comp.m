function [ Mxyz, AMred, A_comp ] = Mred2Mxyz_A_comp( Mred, Imid, Iypos, Iyneg, Lhigh )
...
%                   D135*Acomp);
    ...
    Mxyz = zeros(3*(Nmid+Npos+Nneg),1);
    
    Mxyz(3*(Imid-1)+1) = Mred(1:2:(2*Nmid));
    Mxyz(3*(Imid-1)+3) = Mred(2:2:(2*Nmid));
    
    Mxyz(3*(Iypos-1)+1) = Mred((2*Nmid+1):3:end);
    Mxyz(3*(Iyneg-1)+1) = Mred((2*Nmid+1):3:end);
    Mxyz(3*(Iypos-1)+2) = Mred((2*Nmid+2):3:end);
    Mxyz(3*(Iyneg-1)+2) = -1*Mred((2*Nmid+2):3:end);
    Mxyz(3*(Iypos-1)+3) = Mred((2*Nmid+3):3:end);
    Mxyz(3*(Iyneg-1)+3) = Mred((2*Nmid+3):3:end);
