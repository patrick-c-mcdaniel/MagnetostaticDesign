function [ Call ] = nlcon_Mmax_blockwise( Mxyz, Mmax )
...
%   Mmax - vector of maximum allowable magnetization magnitude for each
%           block, in SI units of magnetic dipole moment 
%           (equal to: Br[T] * Vol[m^3] / MUZ )
%
% Outputs:
