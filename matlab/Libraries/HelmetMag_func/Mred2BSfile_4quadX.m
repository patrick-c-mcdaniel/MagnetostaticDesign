function [ MagBlkStruct ] = Mred2BSfile_4quadX( fn_Mred, fn_MagROI, fn_MagBlkSpec, fn_BSout )
...
%     Mfull = Mred2Mxyz( Mout, inds_mid, inds_pos, inds_neg );
    ...
    Mfull = Mred2Mxyz_A_comp_4quadX(Mout, inds_pp, inds_pn, inds_nn, inds_np, [3 5]);
