...
%% ShimOptRun_190402_v04 -
%   aim for shim coil (no readout gradient)
clear;
close all;

load('./precomp/coil_OptSetupRFLR_Example_200626.mat');
load('./precomp/OptSetupRFLR_Example_200626.mat');
...
% RF_IS_OptSetup_200119_v01;

% btarg_use = coil.btarget;
% 
% load('coil_190402_v02.mat');
% coil.btarget = btarg_use;
...
%MRI_GY
%MRI_GY_170608
%MRI_GY_D13p6in_170608
%MRI_GY_D13p6in_ext2in_170608
%MRI_GY_shield_170608
%MRI_GY_end_170608
%%SSyG_v1_171114
%SSyG_v1_171127
%SSzG_v1_171129
%SSyG_PL_171212
% Gyv2_optsetup_180724
% Gzv2p3_optsetup_180727
%%SSzG_v1_171114
%IWMPI_Drive
...
[coil.Cx,coil.Cy,coil.Cz] = Cn7_par(coil.node,coil.triangle,coil.basis,rk);
...
if strcmp(targetCoil,'dBzdx') || strcmp(targetCoil,'dBzdy') || strcmp(targetCoil,'dBzdz') || strcmp(targetCoil,'shimBz')
    coil.Ctarget = coil.Cz;
elseif strcmp(targetCoil, 'dBydz') || strcmp(targetCoil, 'By')
    coil.Ctarget = coil.Cy;
...
if strcmp(optimizationType,'standardTikhonov')
    ...
    %%% untranspose target field (different code... 18/09/25)
...
elseif strcmp(optimizationType,'QP')
    ...
    % YALMIP
    % Here we try to minimize the inductancefn_coil_red
...
displayStreamFunctionAadj(coil.listTriangle,coil.s,coil.listNode)

coil_red.listTriangle = coil.listTriangle;
coil_red.listNode     = coil.listNode;
coil_red.s            = coil.s;
save(fn_coil_red,'coil_red');
...
% pause
%% 9. Generate Magnetic Field Maps

% x_vp1 = -0.15:0.01:0.15;
% z_vp1 = -0.2:0.01:0.2;
% 
% [xx_p1 zz_p1] = meshgrid(x_vp1, z_vp1);
% 
% rk_plot1 = zeros(numel(xx_p1),6);
% 
% rk_plot1(:,1)  = xx_p1(:);
% rk_plot1(:,3)  = zz_p1(:);
% 
% [Bx_p1, By_p1, Bz_p1] = Field3(wire,coil.current,rk_plot1(:,1)',rk_plot1(:,2)',rk_plot1(:,3)');
% 
% By_p1_rs = reshape(By_p1, [41 31]);
% 
% figure(901); imagesc(x_vp1, z_vp1, By_p1_rs ); colormap jet; colorbar; axis image;

% coil_red.listNode = coil.listNode;
% coil_red.s = coil.s;
% save('coil_red_Gzv2p4_180727.mat','coil_red');
