...
load('./optresults/Gy_coil_red_Example_200626.mat');
...
[cont_Gy_all] = genisocont_sphcord( ver_mesh, fac_mesh, psi_mesh, xyz_ori, tz_bas, Niso,'BSFN',BSFN );


save('./optresults/cont_Gy_all_Example_200626.mat','cont_Gy_all');
