...
load('./optresults/cont_Gz_all_Example_200626.mat');
cont_Gy_all = cont_Gz_all;
...
FN_stl = './STL/STL2D/Gz2D_190916_v05_191008_v04.stl';
...
for iccc = 1:1:numel(cont_Gy_all_dec)
    ...
    FN_stl = ['./STL/Gz_sep/Gz_191008_v05_3d_sep_v04' num2str(iccc,'%02u') '.stl'];
    ...
    FN_stl = ['./STL/STL3D/Gz_191008_v05p4_3d.stl'];
