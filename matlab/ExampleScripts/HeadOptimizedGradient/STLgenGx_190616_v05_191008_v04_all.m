...
load('./optresults/cont_Gx_all_Example_200626.mat');
...
for iccc = INDBACK % 1:1:numel(cont_Gy_all_dec)
    c_tmp = cont_Gy_all_dec{iccc};
    if isempty(c_tmp)
        continue;
    end
...
FN_stl = './STL/STL2D/Gx2D_190916_v05_191008_v04.stl';
...
for iccc = INDBACK %1:1:numel(cont_Gy_all_dec)
    ...
    FN_stl = ['./STL/Gx_sep/Gx_191008_v05_3d_sep_v04' num2str(iccc,'%02u') '.stl'];
    ...
    FN_stl = ['./STL/STL3D/Gx_191008_v05p4_3d.stl'];
