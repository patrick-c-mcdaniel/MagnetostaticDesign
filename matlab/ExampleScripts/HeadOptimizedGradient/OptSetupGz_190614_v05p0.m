...
[listNode, listTriangle, tri] = importMeshWavefront('./mesh/meshGz_Example_200626.obj');
...
save('./precomp/OptSetupGz_Example_200626.mat','Btarg','ROImsk_tar','x3tar','y3tar','z3tar','optimizationType','reg','calculateR','calculateL','calculateLwp','rk','targetCoil');

save('./precomp/coil_OptSetupGz_Example_200626.mat','coil');