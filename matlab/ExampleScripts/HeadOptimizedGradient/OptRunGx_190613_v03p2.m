...
% OptSetupGx_190613_v03p2;

%%% load results from optsetup script
load('./precomp/coil_OptSetupGx_Example_200626.mat');
load('./precomp/OptSetupGx_Example_200626.mat');
...
elseif strcmp(targetCoil, 'dBydz')
...
coil_red.s            = coil.s;
save('./optresults/Gx_coil_red_Example_200626.mat','coil_red');
